...
@Then("Check User navigates to MyAccount Page by passing Email and Password as Excel row {string}")
public void check_user_navigates_to_my_account_page_by_passing_email_and_password_as_excel_row(String rows) {
	...
	try {
		boolean targetpage=myaccpage.isAccountPageExists();
		if(exp_res.equals(targetpage))
	      {
			  if (targetpage ==true) {
